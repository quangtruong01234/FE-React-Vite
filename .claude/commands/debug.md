...
4. **Check related API contracts** in `@api-reference.md` — is the response shape what the code expects?
...
- Do NOT add features.
- Add a test if `@testing.md` is set up (it isn't yet — skip if so).
