...
> Cập nhật: 2026-09-21 · Phạm vi: frontend social + e-commerce (ưu tiên e-commerce).
...
**Gates (chạy lại + verify 2026-09-21):** `npm run build` ✓ · `npm run lint` 0 problem ·
`npm run test:run` **1176 test / 143 file**, all pass. Không đóng item nào khi 3 lệnh này chưa xanh.
