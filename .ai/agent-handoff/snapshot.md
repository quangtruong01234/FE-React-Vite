...
> Cập nhật: 2026-09-15 · Phạm vi: frontend social + e-commerce (ưu tiên e-commerce).
...
**Gates (chạy lại + verify 2026-09-15):** `npm run build` ✓ · `npm run lint` 0 problem ·
`npm run test:run` **1018 test / 125 file**, all pass. Không đóng item nào khi 3 lệnh này chưa xanh.
