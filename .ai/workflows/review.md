...
- [ ] Note: temporary localStorage user cache is a known workaround; backend `GET /user/me` has shipped — FE migration is a pending task tracked in `.ai/context/auth.md` FOLLOW-UP
